...
function ControllerListItem ({ controller, onEdit, onRemove, onConnect, onToggleActive, onToggleDTR }) {
...
export default function ControllersSidebar () {
  ...
  const handleConnectController = (id) => {/*TODO*/}
  ...
  return (
    <Box sx={{ width: 1, height: 1, position: 'relative' }}>
      <ControllerList 
        ...
        onConnect={handleConnectController} 
